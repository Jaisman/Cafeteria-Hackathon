  ...
  return (
    <>
      {isFetching ? (
        ...
        <div
          className="card user-card-full col-xl-8"
                        ...
                        {order.status == "Delivered" ? (
                          <>
                            <button
                              ...
                              type="button"
                              className="btn btn-danger mt-5 m-auto max-w-32 text-center"
                            >
                              {Rewform ? "Cancel" : "Add Review"}
                            </button>
                            {Rewform ? (
                              <>
                                <form
                                  onSubmit={(e) => handleReview(e, order.item)}
                                >
                                  <textarea
                                    name="textarea"
                                    value={review}
                                    ...
                                    id="text"
                                    class=" h-20 w-full resize-none rounded-md border border-slate-300 p-3 my-2"
                                  ></textarea>
                                  <button
                                    type="submit"
                                    disabled={b2}
